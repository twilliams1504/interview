...
public class JsonFlatList<T> {
    ...
    public JsonFlatList(String jsonFilename) {
    	//Initialize gson object and get Type from T
    	gson = new Gson();
    	this.listOfTType = new TypeToken<List<T>>() {}.getType();
    ...
    public List<T> getList()
    {
    	...
    	return ((List<T>) gson.fromJson(jsonString, listOfTType));
