...
public class JsonFileListOfAppointment {
    ...
    public JsonFileListOfAppointment(String jsonFilename) {
    	//Initialize gson object and get Type from T
    	gson = new Gson();
    	this.listOfTType = new TypeToken<List<Appointment>>() {}.getType();
		...
		if (isNewDB) {
    		List<Appointment> emptyList = new ArrayList<Appointment>();
    ...
    public List<Appointment> getList()
    {
    	...
    	return ((List<Appointment>) gson.fromJson(jsonString, listOfTType));
     ...
     */
    public void putList(List<Appointment> list)
    {
